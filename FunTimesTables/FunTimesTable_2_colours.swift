...
//                        }
    ...
    func generateQuestions() {
        ...
        for _ in 1...selectedQuestions {
            let questionIndex = Question.init(first: Int.random(in: rangeOfMultiplications), second: Int.random(in: rangeOfMultiplications))

            questionsArray.append(questionIndex.question)
            answersArray.append(questionIndex.answer)
        }
    }
